...
#define YAS_ACC_DRIVER                      (YAS_ACC_DRIVER_LIS3DH)
	...
	&& !defined(CONFIG_MACH_TIKAL) && !defined(CONFIG_MACH_CHIEF)
...
#if defined(CONFIG_MACH_TIKAL)
#define YAS_DEFAULT_MAGCALIB_DISTORTION_1    (500)
#define YAS_DEFAULT_MAGCALIB_DISTORTION_2    (300)
