...
#define GPIO_DMB_SPI_CLK        S5PV210_GPB(4)
#define GPIO_DMB_SPI_CS0        S5PV210_GPB(5)   
#define GPIO_BL_SCL_28V           S5PV210_GPI(6) 
#define GPIO_BL_SCL_28V_AF       2
#define GPIO_BL_SDA_28V          S5PV210_GPI(6)  
...
*/
//#define GPIO_BUCK_1_EN_A         S5PV210_GPB(6) //L&T added for tikle
#define GPIO_BUCK_1_EN_A         S5PV210_GPJ0(2) //L&T added for tikle

//#define GPIO_GPB7                S5PV210_GPB(7) //L&T added for tikle
#define GPIO_GPB7                S5PV210_GPJ0(3)

#define GPIO_DMB_SPI_MSIO        S5PV210_GPB(6)
#define GPIO_DMB_SPI_MOSI        S5PV210_GPB(7) 

//#define GPIO_BUCK_2_EN           S5PV210_GPB(7) //L&T added for tikle

#define GPIO_BUCK_2_EN           S5PV210_GPJ0(3)
...
#define GPIO_GPI6                S5PV210_GPI(6)  //L&T added 
...
//#define GPIO_CAM_SDA_29V         S5PV210_GPD1(0) //L&T added for tikle
//#define GPIO_CAM_SDA_29V_AF      2

//#define GPIO_CAM_SCL_29V         S5PV210_GPD1(1)
//#define GPIO_CAM_SCL_29V_AF      2

#define GPIO_HDMI_SDA_29V        S5PV210_GPD1(0)
#define GPIO_HDMI_SDA_29_AF      2

#define GPIO_HDMI_SCL_29V         S5PV210_GPD1(1)
#define GPIO_HDMI_SCL_29V_AF      2

#define GPIO_CAM_SDA_29V         S5PV210_MP04(7)
#define GPIO_CAM_SDA_29V_AF      2

#define GPIO_CAM_SCL_29V         S5PV210_MP04(6)
#define GPIO_CAM_SCL_29V_AF      2
...
#define GPIO_WC_DETECT           S5PV210_GPG2(2)
...
#define GPIO_OLED_DET 		 S5PV210_GPH0
...
#define GPIO_KBC0                S5PV210_GPH2(2)
#define GPIO_KBC0_AF             3

#define GPIO_KBC1                S5PV210_GPH2(3)
...
#define GPIO_ACC_GYRO_SCL_2.8V        S5PV210_GPH2(0)
#define GPIO_ACC_GYRO_SDA_2.8V        S5PV210_GPH2(1)

#define GPIO_GYRO_INT           S5PV210_GPH2(4)
#define GPIO_DMB_SPI_IRQ        S5PV210_GPH2(5)
...
//#define GPIO_CAM_FLASH_SET       S5PV210_GPJ0(2) //L&T added for tikle
#define GPIO_CAM_FLASH_SET       GPIO_DUMMY //L&T added for tikle
