...
static struct max8998_charger_data aries_charger = {
	...
	.temp_high_recovery	= 219,
	.temp_low_recovery	= 160,
	.temp_low_threshold	= 157,
	.temp_high_threshold_lpm	= 237,
	.temp_high_recovery_lpm		= 219,
	.temp_low_recovery_lpm		= 160,
	.temp_low_threshold_lpm		= 157,
...
static struct sec_jack_buttons_zone sec_jack_buttons_zones[] = {
	{
		/* 0 <= adc <=125, stable zone */
		.code		= KEY_MEDIA,
		.adc_low	= 0,
		.adc_high	= 125,
	},
	{
		/* 140 <= adc <= 330, stable zone */
		.code		= KEY_VOLUMEUP,
		.adc_low	= 140,
		.adc_high	= 330,
	},
	{
		/* 340 <= adc <= 356, stable zone */
		.code		= KEY_VOLUMEDOWN,
		.adc_low	= 340,
		.adc_high	= 356,
	},
	{
		/* 410 <= adc <= 820, stable zone */
		.code		= KEY_VOLUMEDOWN,
		.adc_low	= 410,
		.adc_high	= 820,
	},
